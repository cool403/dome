...
public class RealCallDelegation {
    ...
    public static void onMethodExit(@Advice.Thrown Throwable t,
            @Advice.This Object call, @Advice.Enter Object fixedValue,
        ...
        Object newResponse = adapter.afterCall(response, t);
        if (newResponse != null) {
