...
public class Okhttp4Adapter extends AbstractOkHttpAdapter {
        ...
        if ("POST".equals(method)) {
            ...
            if (requestBody != null && bufferClz != null) {
                ...
                newRequestBuilder = ReflectMethods.invokeMethod(newRequestBuilderClz, MethodNames.METHOD_METHOD,
                        new Class[] { String.class, requestBodyClz.getSuperclass() }, newRequestBuilder, method, newRequestBody);
    ...
    protected Object fullFillHttpMetricsData(HttpMetricsData httpMetricsData, Object response) {
        ...
        // 获取mediaType
        Object mediaType = ReflectMethods.invokeMethod(responseBodyClz, MethodNames.CONTENT_TYPE_METHOD, responseBody);
        // 获取字节数据
        ...
        Object newResponseBuilder = ReflectMethods.invokeMethod(responseClz, MethodNames.NEW_BUILDER_METHOD, response);
