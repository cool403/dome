        ...
        public static void onMethodEnter(
                ...
                try {
                        ...
                        if (!request.getClass().isAssignableFrom(requestWrapperClass)) {
                                Object wrappedRequest = requestWrapperClass.getConstructor(TargetAppClassRegistry.getClass(ClassNames.HTTP_REQUEST_CLASS_NAME))
                                .newInstance(request);
                                request = wrappedRequest;
                        }
                        if (!response.getClass().isAssignableFrom(responseWrapperClass)) {
                                Object wrappedResponse = responseWrapperClass.getConstructor(TargetAppClassRegistry.getClass(ClassNames.HTTP_RESPONSE_CLASS_NAME))
        ...
        public static void onMethodExit(
                ...
                try {
                        ...
                        if (requestBody.isEmpty()) {
                                InputStream is = (InputStream) ReflectMethods.getMethod(request.getClass(), MethodNames.GET_IS_METHOD).invoke(request);
